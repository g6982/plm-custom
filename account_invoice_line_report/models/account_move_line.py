...
class AccountMoveLine(models.Model):
    ...
    register_date = fields.Date(string="Register Payment Date")
    register_rate = fields.Float(string="Register Rate")
    inv_date = fields.Date(string="Inv or Bill Date")
    
    def _select(self):
        return super()._select() + " , move.invoice_date as inv_date , move.rate_register as register_rate , move.date_register as register_date , move.driver_names as driver , move.rate_khr as rate_khr_inh , move.rate_thb as rate_thb_inh , line.amount_currency as amount_in_currency, move.currency_id as move_currency_id, line.name as label_name , line.product_line_date as expense_date , line.price_total as sub_pricetotal , line.price_unit as price_unit_cus , line.currency_id as currency_id_name " 